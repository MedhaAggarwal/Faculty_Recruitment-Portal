...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // move_uploaded_file($_FILES['userfile']['tmp_name'], 'uploads/' . $photo);
    // move_uploaded_file($_FILES['userfile2']['tmp_name'], 'uploads/' . $id_card_file);

    // SQL query to insert data into the database
    $sql = "INSERT INTO user1 (adv_num, doa, ref_num, post, dept, fname, mname, lname, nationality, dob, gender, mstatus, cast, id_proof, father_name, cadd, cadd1, cadd2, cadd3, cadd4, padd, padd1, padd2, padd3, padd4, mobile, email, mobile_2, email_2, landline)
    VALUES ('$adv_num', '$doa', '$ref_num', '$post', '$dept', '$fname', '$mname', '$lname', '$nationality', '$dob', '$gender', '$mstatus', '$cast', '$id_proof', '$father_name', '$cadd', '$cadd1', '$cadd2', '$cadd3', '$cadd4', '$padd', '$padd1', '$padd2', '$padd3', '$padd4', '$mobile', '$email', '$mobile_2', '$email_2', '$landline')";
  if ($conn->query($sql) === TRUE) {
    // Redirect to the next page
    header("Location: http://localhost/tutor/login2.php/");
...
<div class="row">
  <div class="col-md-12">
      ...
      <select id="adv_num" name="adv_num" class="form-control input-md" required="">
          ...
          <option value="IITP/FACREC-CHE/2023/JULY/02">IITI/FACREC-CHE/2023/JULY/02</option>
              ...
              <div class="col-md-10">
                <div class="row">
                  ...
                  <span class="col-md-2 control-label" for="lname">Last Name *</span>  
                    <div class="col-md-4">
                    <input id="lname" name="lname"name="lname" type="text" placeholder="Last name" class="form-control input-md" maxlength="15" required="">
                    </div>
                 ...
                 <!--  <span class="col-md-2 control-label" for="nationality">Nationality </span>  
                  ...
                  <div class="col-md-4">
                   <!--  <p id="dobdiv"> -->
                  <input id="dob" name="dob" type="text" placeholder="DD/MM/YYYY" class="form-control input-md" required="" onfocusout = "ageCalculator()">
                <!-- </p> -->
                 ...
                 <!--  <span class="col-md-2 control-label" for="age">Age</span>  
                  ...
                  <div class="col-md-4"> 
                    <select id="gender" name="gender" class="form-control input-md" required="">
                      <option selected='selectes' value="">Select</option>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4"> 
                    ...
                    <span class="col-md-2 control-label" for="father_name">Father's Name *</span>  
                      <div class="col-md-4">
                      <input id="father_name" name="father_name"name="father_name" type="text" placeholder="Father's Name" class="form-control input-md" maxlength="30" required="">
                      </div>
                  </div>
            </div>
...
<div class="panel-body">
  ...
  <div class="col-md-4">
  <input id="email" name="email" type="text" placeholder="email" readonly='readonly' value="medhaaggarwal24@gmail.com" class="form-control input-md" required="">
  </div>
...
<div class="col-md-12">
<button id="submit" type="submit" name="submit" value="Submit" class="btn btn-success pull-right">SAVE & NEXT</a></button>
</div>
